document.getElementById('title').innerHTML = window.performance.getEntries()[0].nextHopProtocol && window.performance.getEntries()[0].nextHopProtocol === 'h2' ? 'http/2' : 'http/1.1'
